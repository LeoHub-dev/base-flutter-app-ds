...
class _BtnPrimaryIconSvg extends DefaultBtnInterface {
  _BtnPrimaryIconSvg({
...
class DefaultBtnPrimaryIconSvg extends StatelessWidget {
  const DefaultBtnPrimaryIconSvg({
    Key? key,
    required this.label,
    required this.onTap,

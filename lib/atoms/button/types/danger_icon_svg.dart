...
class _BtnDangerIconSvg extends DefaultBtnInterface {
  _BtnDangerIconSvg({
...
class DefaultBtnDangerIconSvg extends StatelessWidget {
  const DefaultBtnDangerIconSvg({
    Key? key,
    required this.label,
    required this.onTap,

...
class _BtnTertiaryIconSvg extends DefaultBtnInterface {
  _BtnTertiaryIconSvg({
...
class DefaultBtnTertiaryIconSvg extends StatelessWidget {
  const DefaultBtnTertiaryIconSvg({
    Key? key,
    required this.label,
    required this.onTap,

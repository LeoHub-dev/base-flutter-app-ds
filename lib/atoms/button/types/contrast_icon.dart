...
class _BtnContrastIcon extends DefaultBtnInterface {
  _BtnContrastIcon({
...
class DefaultBtnContrastIcon extends StatelessWidget {
  const DefaultBtnContrastIcon({
    Key? key,
    required this.label,
    required this.onTap,

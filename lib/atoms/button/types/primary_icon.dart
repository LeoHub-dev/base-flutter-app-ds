...
class _BtnPrimaryIcon extends DefaultBtnInterface {
  _BtnPrimaryIcon({
...
class DefaultBtnPrimaryIcon extends StatelessWidget {
  const DefaultBtnPrimaryIcon({
    Key? key,
    required this.label,
    required this.onTap,
